...
namespace FutsalProject.Infraestructure.Extensions
{
    public static class RequestExtensions
    {
        ...
        private static readonly Regex x = new Regex(@"Chrome|Edge|Firefox");
        ...
        public static bool UnsoportedBrowser(this HttpRequest request)
        {
            var userAgent = request.UserAgent();
            if (x.IsMatch(userAgent))
            {
                return false;
            }
            return true;
